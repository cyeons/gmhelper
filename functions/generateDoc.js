...
exports.handler = async (event) => {
  ...
  let prompt = `
    ...
    - 단락: 본문 단락 사이는 한 줄 띄우기, 본문과 붙임 사이도 한 줄 띄움, 하위 항목(가., 나. 등) 사이도 반드시 한 줄 띄움.
